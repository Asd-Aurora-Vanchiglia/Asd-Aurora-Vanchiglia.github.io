...
let AppComponent = class AppComponent {
    constructor(router, coverService, cdr) {
        this.router = router;
...
let ArticleService = class ArticleService {
    ...
    get_by_id(id) {
        return _mock_articles_mock__WEBPACK_IMPORTED_MODULE_2__["ARTICLES"].filter(article => article.id === id)[0];
    }
};
...
let ArticleComponent = class ArticleComponent {
    constructor(articlesService, coverService, route) {
...
let ItemNotImplementedComponent = class ItemNotImplementedComponent {
    constructor() { }
    ngOnInit() {
    }
};
